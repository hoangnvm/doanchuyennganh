@php
    ...
    $elements = [
        [
            ...
            'element'   => Form::text('title', null,   $formInputAttr  )
        ],
        [
        ...
        [
            ...
            'element'   => Form::text('position', null,   $formInputAttr  )
        ],
        [
            'label'     => Form::label('amount', 'Số lượng', $formLabelAttr  ),
            'element'   => Form::text('amount', null,   $formInputAttr  )
        ],
        [
        ...
        [
            ...
            'element'   => Form::select('work_type_id' ,$workTypelValue, null,   $formInputAttr)
        ], 
        [
        ...
        [
            ...
            'element'   => Form::select('type' ,$typeValue, null,   $formInputAttr)
        ], 
        [
        ...
        [
            ...
            'element'   => Form::text('phone_contact', null,   $formInputAttr  )
        ],
        [
            'label'     => Form::label('email_contact', 'Email', $formLabelAttr  ),
            'element'   => Form::text('email_contact', null, $formInputAttr)
        ],
        [
            'label'     => Form::label('name_contact', 'Tên liên hệ', $formLabelAttr  ),
            'element'   => Form::text('name_contact', null, $formInputAttr)
        ],
        [
