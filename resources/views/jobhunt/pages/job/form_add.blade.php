@php
    ...
    $elements = [
        [
            'label'     => 'Tên công việc',
            'element'   => Form::text('title', null),
            'class'     => 'col-lg-12'
        ],
        [
            'label'     => 'Ngành nghề',
            'element'   => Form::select('career_id' ,$careerValue, null,   ['class' => 'chosen']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Nơi làm việc',
            'element'   => Form::text('work_place', null),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Vị trí cần tuyển',
            'element'   => Form::text('position', null),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Số lượng',
            'element'   => Form::text('amount', null),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Mức lương',
            'element'   => Form::select('salary_id' ,$salaryValue, null,   ['class' => 'chosen']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Trình độ',
            'element'   => Form::select('level_id' ,$levelValue, null,   ['class' => 'chosen']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Kinh nghiệm',
            'element'   => Form::select('experience_id' ,$experienceValue, null, ['class' => 'chosen']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Hình thức làm việc',
            'element'   => Form::select('work_type_id' ,$workTypelValue, null, ['class' => 'chosen']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Giới tính',
            'element'   => Form::select('gender' ,$genderValue, null, ['class' => 'chosen']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Ngày hết hạn',
            'element'   => Form::date('expiration_date', null, ['class' => 'form-control', 'id'=>'datetimepicker']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Mô tả',
            'element'   => Form::textArea('description', null, $formCkeditorAttr),
            'class'     => 'col-lg-12'
        ],
        [
            'label'     => 'Yêu cầu công việc',
            'element'   => Form::textArea('required', null, $formCkeditorAttr),
            'class'     => 'col-lg-12'
        ],
        [
            'label'     => 'Quyền lợi',
            'element'   => Form::textArea('benefit', null, $formCkeditorAttr),
            'class'     => 'col-lg-12'
        ],
        [
            'label'     => 'Số điện thoại',
            'element'   => Form::text('phone_contact', @$item['phone']),
            'class'     => 'col-lg-6'
        ],
        [
            'label'     => 'Email',
            'element'   => Form::text('email_contact', @$item['email']),
            'class'     => 'col-lg-6'
        ],
        [
        ...
        [            
            'element'   => $inputHiddenTask . 'Đăng tin tuyển dụng',
            'type'      => 'btn-submit',
            'class'     => 'col-lg-12'
        ]
    ];
