    ...
    class UserController extends Controller
    {
        ...
        public function changePassword(MainRequest $request){
            if($request->method() == "POST"){
                ...
                return redirect()->route($this->controllerName)->with('my_notify', 'Cập nhật thành công!');
           }        
        }
    
    
        public function changeRolePost(MainRequest $request){
            if($request->method() == "POST"){
                $params = $request->all();
        ...
        public function delete(Request $request){
            ...
            return redirect()->route($this->controllerName)->with('my_notify', 'Xoá thành công!');
        }
        ...
        public function changeRole(Request $request){
            $params['currentRole'] = $request->role;
            $params['id'] = $request->id;
