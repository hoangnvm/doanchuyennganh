@php
    ...
    $elements = [
        ...
        [
            ...
            'element'   => Form::select('company_size_id' ,$companySizeValue, $item['company_size_id'],   $formInputAttr)
        ],        
        [
            'label'     => Form::label('founded_year', 'Ngày thành lập',  $formLabelAttr  ),
            'element'   => Form::date('founded_year', $item['founded_year'], ['class' => 'form-control', 'id'=>'datetimepicker']) 
        ],  
        [
